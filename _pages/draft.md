...
1. Simulations from Ivanova et al. in 2003 showed that a heavy He-NS binary can survive unstable case BB mass transfer, with one of their simulated binaries retaining a $$ 3.01 M_{\odot} $$ helium star after the common envelope.
